...
export default function WishlistView() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {items.length === 0 ? (
        <div className="mt-10 flex flex-col items-center rounded-card bg-neutral-50 py-20 text-center">
          ...
          <p className="mt-5 text-[15px] font-bold text-ink">Your wishlist is empty</p>
