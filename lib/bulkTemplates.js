...
const PRICING = [
  c("deviceCost", "deviceCost", "PRICING & STOCK", "numpos", { note: "Enter the final selling price (inclusive of default RAM and SSD)" }),
...
const CONTENT = [
  ...
  c("whats_in_box", "whatsInBox", "CONTENT", "free", { note: "One item per line, use line breaks" }),
...
// Physical CPU sockets (servers/workstations). Top-level field, default 1.
const PROC_COUNT = c("processor_count", "processorCount", "SPECIFICATIONS", "num", { note: "1, 2 or 4 — blank = 1" });
...
const SPECS = {
  ...
  Workstations: [WS_CHASSIS, PROC, PROC_COUNT, GEN, RAMTYPE, RAMEXP, RAM, SSD, GPU, PSU, OS],
  Servers: [SRV_FF, PROC, PROC_COUNT, GEN, RAMTYPE, RAM, STORAGE, DRIVEBAYS, RAID, REDUN, SERVER_OS_COL],
};
...
export const CATEGORY_EXAMPLES = {
  ...
  Workstations: [{ category: "Workstations", brand: "HP", model: "Z440", chassisType: "Tower", processor: "Xeon E5-1620", processor_count: 1, generation: "", ramType: "DDR4 ECC", ramExpandability: "Expandable", defaultRam: "32GB", defaultSsd: "512GB", gpu: "NVIDIA Quadro K2200", psu: "700W", os: "Windows 11 Pro", deviceCost: 45000, mrp: 120000, chassisStock: 3, condition: "Good", warrantyPeriod: "1 year", hsnCode: "8471", "USB-A": 4, DisplayPort: 2, "Ethernet (RJ45)": 1, description: "", seoTitle: "" }],
  Servers: [{ category: "Servers", brand: "HPE", model: "ProLiant DL380 G10", formFactor: "2U", processor: "Xeon Silver 4210", processor_count: 2, generation: "", ramType: "DDR4 ECC", defaultRam: "32GB", storage: "1TB", driveBays: 8, raidSupport: "RAID 1", redundantPower: "Yes", serverOs: "No OS", deviceCost: 85000, mrp: 210000, chassisStock: 2, condition: "Good", warrantyPeriod: "1 year", hsnCode: "8471", "USB-A": 4, "Ethernet (RJ45)": 1, VGA: 1, description: "", seoTitle: "" }],
};
