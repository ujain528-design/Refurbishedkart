...
export const adminUpdateOrderStatus = (id, status, cancellationReason) =>
  put(`/api/admin/orders/${id}/status`, { status, ...(cancellationReason ? { cancellationReason } : {}) }).then((r) => r.order);
