...
export function specRowsFor(product) {
  ...
  return [
    ...
    ["Battery", isLaptop ? "Min. 80% health — tested & certified" : undefined],
...
export function descriptionFor(product) {
  ...
  const generated = [
    ...
    `Your purchase is covered by a ${warranty} warranty and a 7-day no-questions replacement window, with a GST invoice included for business buyers.`,
  ];
