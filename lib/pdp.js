...
export function specRowsFor(product) {
  ...
  return [
    ...
    // (with its real value); otherwise a neutral "Tested & certified" line — no
    // blanket 80% claim, which isn't accurate for every unit.
    ["Battery", isLaptop && !a.batteryHealth ? "Tested & certified" : undefined],
