...
const OrderSchema = new Schema(
  {
    ...
    status: { type: String, default: "Confirmed" }, // Pending | Confirmed | Packed | Shipped | Delivered | Cancelled | Returned
    cancelledAt: Date,
...
const PricingConfigSchema = new Schema(
  { _id: String, ram: { type: Object, default: {} }, ssd: { type: Object, default: {} } },
  { timestamps: true }
);
