...
export const MASTER_TABLES = {
  // "Return Reason" intentionally NOT a managed master table — return reasons are
  // a fixed list in lib/data.js (RETURN_REASONS), shared by the customer + admin
  // return forms. Editing it here would have no effect, so it's not shown.
...
export const PROCESSOR_MODELS = {
  ...
  "Intel Celeron": ["N4020", "N4500", "N5100", "3865U", "5205U"],
  "Intel Pentium": ["Gold 7505", "Silver N5030", "Gold 4417U", "Gold G6400"],
