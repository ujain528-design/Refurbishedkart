...
export const RESOLUTIONS = ["1366×768 HD", "1920×1080 FHD", "2560×1440 QHD", "3840×2160 4K", "2560×1600", "1920×1200", "2560×1080", "3440×1440"];
...
export const DATA_WIPE_STANDARDS = ["DoD 5220.22-M", "NIST 800-88", "ATA Secure Erase", "Physical Destruction", "Not Applicable"];
...
export const SPEC_FIELDS = {
  ...
  dataWipe: { label: "Data Wipe Standard", type: "dropdown" },
};

export const CATEGORY_SPEC_SCHEMA = {
  Laptops: ["processor", "generation", "displaySize", "resolution", "panelType", "refreshRate", "touchscreen", "ramType", "storageType", "os", "battery", "weight", "ports", "warranty", "dataWipe"],
  Desktops: ["processor", "generation", "formFactor", "ramType", "storageType", "os", "ports", "warranty", "dataWipe"],
  Monitors: ["displaySize", "resolution", "panelType", "refreshRate", "ports", "warranty"],
  Servers: ["processor", "generation", "formFactor", "ramType", "storageType", "os", "ports", "warranty", "dataWipe"],
  Workstations: ["processor", "generation", "displaySize", "ramType", "storageType", "os", "gpu", "ports", "warranty", "dataWipe"],
};
