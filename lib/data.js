...
export const WHY_STATS = [
  ...
  { target: 32, suffix: "-pt", label: "Grade certification on every unit", note: "Every unit graded and certified before listing." },
];
...
export const REVIEWS = [
  {
    ...
    text: "Honestly couldn't tell it was refurbished. The condition matched exactly what was advertised. Three months in, zero issues.",
  },
  {
    name: "Priya Nair",
    city: "Kochi",
...
export const FAQS = [
  ...
  {
    q: "How is the battery backup on refurbished laptops?",
    a: "Every laptop's battery is tested for 1.5hr+ backup during inspection. Batteries that don't meet this are replaced before sale.",
  },
  {
