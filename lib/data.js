...
export const WHATSAPP_NUMBER = "919876543210"; // configurable from admin settings in real build
...
export const FAQS = [
  {
    ...
    a: "Every device is sourced from corporate IT fleets, run through a 32-point hardware inspection, professionally cleaned, securely data-wiped to NIST standards, and re-imaged with genuine Windows. Anything that fails inspection gets repaired with OEM-grade parts or rejected.",
  },
  {
    q: "What warranty do I get?",
    a: "Every product ships with a minimum 6-month onsite warranty, extendable to 1 year at checkout. Warranty covers all hardware faults — no fine print on 'wear and tear' for core components.",
  },
  {
    q: "Can I return a device if I don't like it?",
    a: "Yes. 7-day no-questions-asked replacement or refund. If the device doesn't match its listing, return shipping is on us.",
  },
  {
...
export const POLICIES = [
  ...
  { label: "Certified Data Wiped", icon: "wiped" },
];
...
export const FOOTER_COLS = [
  ...
  {
    title: "Support",
    links: ["Track Order", "Warranty Claim", "Returns & Refunds", "FAQs", "Contact Us"],
  },
  {
    title: "Business",
